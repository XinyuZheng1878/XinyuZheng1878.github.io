  ...
  return (
    <aside className="lg:w-1/3 lg:h-screen lg:sticky lg:top-0 flex-shrink-0">
      <div className="h-full flex flex-col justify-center px-8 py-12 lg:py-16 lg:pl-12 lg:pr-10">
        ...
        {/* Brief Bio */}
        <p className="mt-5 text-[15px] leading-relaxed text-gray-500 max-w-xs">
          致力于让机器更好地理解世界，专注于表示学习与多模态推理。
        </p>
        ...
        <div className="mt-6 flex items-center gap-2">
          ...
          <a href="#" aria-label="Twitter" className="flex h-9 w-9 items-center justify-center rounded-full bg-white text-gray-500 shadow-sm ring-1 ring-black/5 transition-all hover:-translate-y-0.5 hover:text-accent-dark hover:bg-accent-soft">
            <svg className="h-4 w-4" fill="currentColor" viewBox="0 0 24 24"><path d="M18.9 1.5h3.7l-8 9.2 9.4 12.4h-7.4l-5.8-7.6-6.6 7.6H.5l8.6-9.8L.1 1.5h7.6l5.2 6.9 5.9-6.9zm-1.3 19.9h2L6.5 3.5H4.4l13.2 17.9z"/></svg>
          </a>
        </div>
